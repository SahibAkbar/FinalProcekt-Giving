        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Money = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonaterTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    DonaterCount = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    VoluteerTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    VoluteerCount = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
